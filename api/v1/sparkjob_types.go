...
type SparkJobSpec struct {
	...
	// Foo is an example field of SparkJob. Edit sparkjob_types.go to remove/update
...
type SparkJob struct {
	...
	Spec   SparkJobSpec   `json:"spec,omitempty"`
	Status SparkJobStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// SparkJobList contains a list of SparkJob
